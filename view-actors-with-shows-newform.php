...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newActorsWithShowsModal">
...
<!-- Modal -->
<div class="modal fade" id="newActorsWithShowsModal" tabindex="-1" aria-labelledby="newActorsWithShowsModallabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newActorsWithShowsModallabel">New Episode</h1>
