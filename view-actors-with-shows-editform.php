...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editActorsWtihShowsModal<?php echo $course['episode_id'];?>">
...
<!-- Modal -->
<div class="modal fade" id="editActorsWithShowsModal<?php echo $course['episode_id'];?>" tabindex="-1" aria-labelledby="editActorsWithShowsModalLabel<?php echo $course['episode_id'];?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editActorsWithShowsModalLabel<?php echo $course['episode_id'];?>">Edit Episode</h1>
